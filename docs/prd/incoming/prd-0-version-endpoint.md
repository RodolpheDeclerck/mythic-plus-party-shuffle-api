...
Re-run: validate pipeline and CLAUDE.md updates (controller, tests, workflow). Rules non-negotiable over PRD. Claude must push only with 100% coverage on new code.
